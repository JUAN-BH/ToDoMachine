...
export const EditPage = () => {
  ...
  const taskToDisplay = tasksSaved.find((t) => t.id === toDo);
  ...
  return (
    ...
    >
      <article className="modalContainer__modal">
        ...
        <h2 className="modalContainer__modal__title">Edit Task</h2>
        <form className="modalContainer__modal__form" onSubmit={updateTask}>
          <input
            type="text"
            name="task"
            defaultValue={taskToDisplay.task}
            className="taskInput"
            autoComplete="off"
          />
          <input
            ...
            className="btnModal"
          />
          <input type="submit" name="edit" value="Edit" className="btnModal" />
        </form>
      </article>
    </section>
  );
